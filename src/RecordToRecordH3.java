 ...
 */
public class RecordToRecordH3 implements Solver {
     ...
     * Implementation of record-to-record heuristic for the DAVRP
     */
    public RecordToRecordH3(int K, int D, int P, int NBListSize, double beta) {
        // Parameters
        this.K = K;
        this.D = D;
        this.P = P;
...
//                    System.out.println("d = " + d);
                ...
                boolean moveMade;
                do {
//                    System.out.println("improvement loop");
                    moveMade = false;
                    for (Customer i : routeSet.getCustomers()) {
                        if (i.getId() != 0) {
            ...
            if (record < bestRouteSet.getRouteLength()) {
                bestRouteSet = recordSet.getCopy();
            }
        }
