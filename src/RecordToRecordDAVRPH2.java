 ...
 * H1 with better two-opt
 */
public class RecordToRecordDAVRPH2 implements Solver {
    ...
    public Solution solve(DataSet dataSet) {
        ...
        RecordToRecordH2 rtr = new RecordToRecordH2(K, I, M, NBListSize, beta);
