 ...
 */
public class RecordToRecordDAVRPH4 implements Solver {
    ...
    public Solution solve(DataSet dataSet) {
        ...
        RecordToRecordH3 rtr = new RecordToRecordH3(D, K, P, NBListSize, beta);
